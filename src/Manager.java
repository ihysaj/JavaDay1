public class Manager extends AbsEmployee{
    ...
    public Manager( double salesDone, double numberOfHoursWorked,
                   double hourlyRate, double basePay, String name) {
        super(numberOfHoursWorked, hourlyRate, basePay, name);
